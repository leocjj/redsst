					...
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-12 col-12-medium">
								<h3>Ofertas de Empleo SST.</h3> Encuentra el empleo en SST que estabas buscando.
							</div>
						</div>
					</div>
				</div>
...
<!-- ------------------------- SEGUNDO PASO ----- BUSCAR HOJAS DE VIDA  --------------------------------------------------------------------------------------->
								<div Style="color:red;"><h3>2) B&uacute;squeda de Ofertas de Empleo</h3></div>
								<div style=" color:navy; text-align:justify ">
									Debes suministrar tu correo electr&oacute;nico y el c&oacute;digo de acceso recibido para hacer la b&uacute;squeda.<br/>
									Los campos marcados con este s&iacute;mbolo (*), son obligatorios.<br/><br/></div>
								<div class="row gtr-uniform">
									<form method="post" id="formulario_buscar_empleo" action="" autocomplete="off">
											<div><input type='email' name='correo_ingreso2' maxlength="55" placeholder=" * Correo electr&oacute;nico registrado " class="email" required/></div>
											<div><input type='text' name='codigo_ingreso2' maxlength="8" placeholder=" * C&oacute;digo de acceso " class="email" required/></div>
											
								            <!---------------------  CAMPOS PARA FILTRAR LA INFORMACIÓN DE BÚSQUEDA ------ -->
								            ...
								            <!---------------------  CAMPOS PARA ORDENAR LA INFORMACIÓN DE BÚSQUEDA ------ 
								            Seleccione una opción para ordenar el resultado por:
											...
											<!--------------------------------------------------------------------------------------------------------->
									            <div >	
									            		<br/><br/><input type='submit' value='Buscar ofertas de empleo' class="special" />
									            </div>			
									            <div Style="color:red;" id="respuesta_buscar_empleo">  </div>		<!-- debe ser con ID, no funciona con name  -->
									</form>
