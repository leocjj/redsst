			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>EVENTOS<br/>Seguridad y Salud en el Trabajo - SST</h1>

								<blockquote>
									<b>Eventos profesionales especializados en SST.</b><br/>
									Ingresa tu evento, actual&iacute;zalo o busca el evento de tu inter&eacute;s y se parte de Red SST.
								</blockquote>
							...
							<!-- <div Style="color:green;">  ¡Nuevo!</div> -->
							
							<h2>Selecciona la opci&oacute;n de tu inter&eacute;s</h2>
							<section class="tiles">
								<article class="style1">
									<span class="image">
										<img src="images/pic01.jpg" alt="Ingresar Hoja de Vida" />
									</span>
									<a href="eventos_ingresar.php">
										<div Style="color:green;"><b> ¡ NUEVO !  </b></div>
										<h2> Ingresar evento <br/></h2>
										<div class="content">
											<p>Ingresa tu evento <b>en solo 3 pasos</b> y se parte de Red SST.<br/></p>
										</div>
									</a>
								</article>
								<article class="style2">
									<span class="image">
										<img src="images/pic02.jpg" alt="Actualizar Hoja de Vida" />
									</span>
									<a href="">
										<h2>Actualizar evento<br/><div Style="color:orange;">¡En construcci&oacute;n!</div></h2>
										<div class="content">
											<p>Actualiza tu evento SST de forma r&aacute;pida y sencilla.</p>
										</div>
									</a>
								</article>
								...
								<article class="style3">
									<span class="image">
										<img src="images/pic03.jpg" alt="Buscar Hoja de Vida" />
									</span>
									<a href="eventos_buscar.php">
										<div Style="color:green;"><b> ¡ NUEVO !  </b></div>
										<h2> Buscar evento </h2>
										<div class="content">
											<p>Encuentra directamente aqu&iacute; el evento de tu inter&eacute;s.</p>
										</div>
									</a>
								</article>
								<!--
