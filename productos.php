			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Productos<br/>Seguridad y Salud en el Trabajo - SST</h1>

								<blockquote>
									<b>Productos especializados en SST.</b><br/>
									Encuentra los productos que necesitas especializados en SST.
								</blockquote>
							...
							<section class="tiles">
								<article class="style1">
									<span class="image">
										<img src="images/polimodular_verysmall.jpg" alt="Ingresar Hoja de Vida" />
									</span>
									<a href="polimodular.php">
										<div Style="color:green;"> <b> ¡Nuevo!</b></div>
										<h2> Policarbonato a la medida<br/></h2>
										<div class="content">
											<p>Solicita las láminas de policarbonato que necesites para ensamblar la guarda de seguridad de maquinaria.<br/></p>
										</div>
									</a>
								</article>
								<article class="style2">
									...
									<a href="#">
										<h2> - <br/><div Style="color:orange;">  ¡EN CONSTRUCCI&Oacute;N!</div></h2>
										<div class="content">
											<p>Pr&oacute;ximamente m&aacute;s productos SST.</p>
										</div>
									</a>
								</article>
