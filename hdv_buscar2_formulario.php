...
<div><input type='email' name='correo_ingreso2' id='correo_ingreso2' maxlength='55' placeholder=' * Correo electr&oacute;nico ' class='email' value=$fila[1] required/></div>
<div><input type='text' name='codigo_ingreso2' id="codigo_ingreso2" maxlength="8" placeholder=" * C&oacute;digo de acceso " class="email" value='********' required/></div>
<div><input type='text' name='nombre' id="nombre" maxlength="55" placeholder=" * Nombre(s) " class="nombre" value=$fila[2] required/></div>
<div><input type='text' name='apellido' id="apellido" maxlength="55" placeholder=" * Apellido(s) " value=$fila[3] required/></div>
...
<div><label for="telefono1">Tel&eacute;fono</label><input type="text" name='telefono1' id="telefono1" maxlength="20" placeholder=" * Tel&eacute;fono m&oacute;vil " required/></div>
