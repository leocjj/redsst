					...
					<div id="banner" class="box container">
						<div class="row">
							<div class="col-12 col-12-medium">
								<h3>Ofertas de empleo para profesionales en SST.</h3> Ingresa tu oferta de empleo <b>en solo 3 pasos</b> y se parte de Red SST.
							</div>
						</div>
					</div>
				</div>
...
<!-- ------------------------- SEGUNDO PASO ----- INGRESAR DATOS PERSONALES ----------------------------------------------------------------------------------------------->
								<!--------------------- INGRESAR CORREO, CÃ“DIGO VÃLIDO Y HOJA DE VIDA. SE VERIFICAN EN EL ARCHIVO procesar_ingreso_empleo.php  -------------->	
								<div Style="color:red;"><h3>2) Ingreso de Oferta de Empleo</h3></div>
								...
								<div class="row gtr-uniform">
									<form method="post" id="formulario_ingreso_empleo" action=""  autocomplete="off">
											<?php include 'empleo_formulario.php'; ?>  <!--ARCHIVO DONDE EST�N TODOS LOS INPUT DEL FORMULARIO. ES COMUN A empleo_INGRESAR Y empleo_ACTUALIZAR-->

<!-- ------------------------- TERCER PASO ----- GUARDAR HOJA DE VIDA ---------------------------------------------------------------------------------------------------->
										<br/><br/>
							            <div Style="color:red;"><h3>3) Guardar Oferta de Empleo</h3></div>
										<div style="color:navy; text-align:justify ">
												...
												<div class="6u 12u$(small)">
														...
														<label for="autorizohabeasdata">
															Autorizo el tratamiento de los datos suministrados de acuerdo con la <a href="habeas_data.pdf" target="_blank">
							            ...
							            <div >	
							            		<br/>
							            		<input type="hidden" name="actualizar" id="actualizar" value='No' class="special" hidden="hidden" />
							            		<input type='submit' name="guardar" value='Guardar' class="special"/>
							            		<!--CODIGO SI SE QUIERE EVITAR QUE AL DAR ENTER SE SUBMITA EL FORMULARIO. PERO REFRESCA LA PÃGINA, NO FUNCIONA CON AJAX.
...
<!-- ------------------------- FIN DEL FORMULARIO  -------------------------------------------------------------------------------------------------------------------------->
								...
								<div style="line-height:95%; color:navy; text-align:justify ">
										<br/><b>Nota:</b> Para modificar los datos ingresados puedes ir a la opci&oacute;n Actualizar oferta de empleo en el men&uacute;.
